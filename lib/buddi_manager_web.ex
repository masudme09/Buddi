defmodule BuddiManagerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: BuddiManagerWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BuddiManagerWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import BuddiManagerWeb.Gettext
      import HeexIgnore
      import BuddiManagerWeb.CoreComponents
